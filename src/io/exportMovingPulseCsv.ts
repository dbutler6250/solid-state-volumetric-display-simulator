...
export function exportMovingPulseCsv(
  ...
  const lines = [
    ...
    formatCommentLine('responseClassification', result.metrics.localization.responseClassification),
    formatCommentLine('secondaryPeakRatio', result.metrics.localization.secondaryPeakRatio ?? ''),
    formatCommentLine('peakDominance', result.metrics.localization.peakDominance ?? ''),
    formatCommentLine('localizedFraction', result.metrics.localization.localizedFraction ?? ''),
    formatCommentLine('boundaryDominated', result.metrics.localization.boundaryDominated ? 'true' : 'false'),
