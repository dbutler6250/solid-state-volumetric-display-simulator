...
- Preserved the default acoustic medium and imported acoustic materials not present in the optical material catalog so the acoustic-medium dropdown can switch away and back.
...
- Verified with tests/lint/build that the acoustic workflow remains valid after preserving non-catalog acoustic medium options.
