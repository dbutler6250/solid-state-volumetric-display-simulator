...
- Completed WP-v2-03 fixed-laser moving active-region experiment on top of the v2 hybrid architecture foundation and WP-v2-02 validation.
...
- Full test: `npm.cmd run test` - passed, 27 files / 171 tests.
